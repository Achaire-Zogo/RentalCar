        ...
        <div class="row">
          <div class="col-md-5 col-md-push-7">
            <div class="banner_content">
              <h1>&nbsp; RandyCar,</h1>
              <p>&nbsp;the best rental car you can choose</p>
            </div>
          </div>
        </div>
      </div>
          ...
          <div role="tabpanel" class="tab-pane active" id="resentnewcar">
            ...
            ?>
                ...
                <div class="col-list-3" >
                  <div class="recent-car-list" style="width: 300px;height: 300px">
                    <div class="car-info-box"> <a href="vehical-details.php?vhid=<?php echo htmlentities($result->id); ?>"><img src="admin/img/vehicleimages/<?php echo htmlentities($result->Vimage1); ?>" style="width: 300px;height: 150px" class="img-responsive" alt="image"></a>
                      <ul>
