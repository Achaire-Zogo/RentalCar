        ...
        <div class="container">
          ...
          <div class="similar_cars">
            ...
            <div class="row">
              ...
              if ($query->rowCount() > 0) {
                foreach ($results as $result) { ?>
                  <div class="col-md-3 grid_listing" style="width: 300px;height: 300px">
                    <div class="product-listing-m gray-bg">
                      <div class="product-listing-img"> <a href="vehical-details.php?vhid=<?php echo htmlentities($result->id); ?>"><img src="admin/img/vehicleimages/<?php echo htmlentities($result->Vimage1); ?>" style="height: 150px" class="img-responsive" alt="image" /> </a>
                      </div>
